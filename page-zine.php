...
<img class="rocket-lazyload" src='<?php echo $wp_url; ?>/assets/img/zine_01.png' alt='zine1号' width="500px">
...
<div class="uk-flex uk-flex-wrap uk-flex-center uk-flex-middle">
<div><img class="rocket-lazyload" src='<?php echo $wp_url; ?>/assets/img/zine_02.png' alt='zine1号' width="500px"></div>
<div class="zine__text">
